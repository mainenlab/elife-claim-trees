...
- [Configuration reference](/elife-claim-trees/docs/reference/config/) — every flag and env var
- [Code structure](/elife-claim-trees/docs/contributing/code-structure/) — where things live and why
- [Design decisions](/elife-claim-trees/docs/contributing/design-decisions/) — ADR-style record of architectural choices
