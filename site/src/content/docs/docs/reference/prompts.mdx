...
This page is the reference for what's in each prompt and where it lives. For the design rationale, see [the three-agent partition](/docs/architecture/three-agent-partition/) and [the external reviewer](/docs/architecture/external-reviewer/). For authoring variants, see [adding a prompt variant](/docs/contributing/prompt-variant/).
...
Validate via `evaluate --prompt-variant <variant-name>` before deployment. See [adding a prompt variant](/docs/contributing/prompt-variant/) for the full workflow.
...
- [The three-agent partition](/docs/architecture/three-agent-partition/) — design rationale for the three extraction prompts
- [The external reviewer](/docs/architecture/external-reviewer/) — design rationale for the reviewer prompt
- [Adding a prompt variant](/docs/contributing/prompt-variant/) — workflow for authoring and testing variants
