...
This page is the comprehensive reference for the system's configuration surface. For the operational guide on which knobs to use when, see [cost and performance](/elife-claim-trees/docs/cli/cost/) and [review modes](/elife-claim-trees/docs/cli/review-modes/).
...
- [Cost and performance](/elife-claim-trees/docs/cli/cost/) — operational guide on which configuration choices matter
- [Review modes — when to use each](/elife-claim-trees/docs/cli/review-modes/) — the most consequential configuration choice
- [Adding a prompt variant](/elife-claim-trees/docs/contributing/prompt-variant/) — how the `--prompt-variant` flag works
