...
- [The 9 roles](/docs/reference/roles/) — what roles claims with which edges
- [The claim schema](/docs/methodology/schema/) — where edges fit in the full claim file
- [Design decisions](/docs/contributing/design-decisions/) — why Step 6 is scaffolded rather than auto-inferred
