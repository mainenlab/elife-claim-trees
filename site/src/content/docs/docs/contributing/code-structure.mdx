...
This page is the orientation for someone who will read or modify the source. For the public API, see [API reference](/docs/reference/api/). For the operational behavior, see the architecture pages.
...
These are explicit tradeoffs, not oversights. See [design decisions](/docs/contributing/design-decisions/) for the rationale.
...
- **New prompt variant:** see [adding a prompt variant](/docs/contributing/prompt-variant/).
...
- [Adding a prompt variant](/docs/contributing/prompt-variant/) — the most common extension
- [Running validation](/docs/contributing/validation/) — how to use `evaluate` to validate changes
- [Design decisions](/docs/contributing/design-decisions/) — ADR-style record of why the code looks the way it does
