...
- [Code structure](/elife-claim-trees/docs/contributing/code-structure/) — module organization that follows from these decisions
- [Adding a prompt variant](/elife-claim-trees/docs/contributing/prompt-variant/) — the extension point that respects the architecture
- [Iteration discipline](/elife-claim-trees/docs/validation/iteration/) — the empirical discipline that validates each decision
