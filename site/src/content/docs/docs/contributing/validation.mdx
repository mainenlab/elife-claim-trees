...
For the methodology behind validation, see [how we measure quality](/docs/validation/methodology/). For the canonical worked example, see [iteration discipline](/docs/validation/iteration/) (kammer prompt iteration).
...
- [How we measure quality](/docs/validation/methodology/) — the round-trip methodology in detail
- [Iteration discipline](/docs/validation/iteration/) — kammer worked example
- [Adding a prompt variant](/docs/contributing/prompt-variant/) — the most common change to validate
