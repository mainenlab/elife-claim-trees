...
- [The external reviewer (Step 4.5)](/elife-claim-trees/docs/architecture/external-reviewer/) — what runs after reconciliation in `external` mode
- [The review gate](/elife-claim-trees/docs/architecture/review-gate/) — Step 5 and the four review modes
- [The prompts reference](/elife-claim-trees/docs/reference/prompts/) — the full reconciler prompt text
