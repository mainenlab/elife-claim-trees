...
<Aside type="note">
  ...
  [the prompts reference](/docs/reference/prompts/) for the full text.
</Aside>
...
The 10-paper sweep across the public eLife corpus confirms the result generalizes — see [validation results](/docs/validation/results/) for per-paper detail.
...
- The full reviewer prompt is at [the prompts reference](/docs/reference/prompts/)
- [The 10-paper sweep results](/docs/validation/results/) shows how the reviewer performs across the corpus
- [The iteration discipline](/docs/validation/iteration/) walks through the kammer prompt iteration that added Biases 5, 6, and 7
- [Review modes — when to use each](/docs/cli/review-modes/) compares the four review options
