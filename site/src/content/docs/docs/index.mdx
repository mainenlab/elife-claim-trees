...
<CardGrid>
  <Card title="Overview" icon="rocket">
    ...
    [Read overview →](/elife-claim-trees/docs/overview/what-this-is/)
  </Card>
  ...
  <Card title="Architecture" icon="setting">
    ...
    [See architecture →](/elife-claim-trees/docs/architecture/pipeline/)
  </Card>
  ...
  <Card title="Using the CLI" icon="laptop">
    ...
    [Get started →](/elife-claim-trees/docs/cli/install/)
  </Card>
...
If you are looking for the methodology rather than the implementation, see [`docs/method.md`](/elife-claim-trees/method/) in the corpus repo. If you are looking for the per-paper claim graphs, see [`/papers/`](/elife-claim-trees/papers/).
