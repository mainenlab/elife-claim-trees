...
- [Cost and performance](/docs/cli/cost/) — per-step breakdown for tuning
- [Validation results](/docs/validation/results/) — what to expect from a 10-paper sweep
- [Iteration discipline](/docs/validation/iteration/) — how to validate prompt changes before deploying
