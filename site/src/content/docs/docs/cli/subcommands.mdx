...
The four review modes have very different cost/quality profiles. See [review modes — when to use each](/docs/cli/review-modes/) for the operational decision tree.
...
Use `evaluate` to validate prompt iterations, model substitutions, or new review modes empirically before deployment. See [the iteration discipline](/docs/validation/iteration/) for the workflow.
...
- [Review modes — when to use each](/docs/cli/review-modes/) — the operational decision for `write`
- [Configuration reference](/docs/reference/config/) — every env var and flag in detail
- [Batch operation](/docs/cli/batch/) — running on many papers
