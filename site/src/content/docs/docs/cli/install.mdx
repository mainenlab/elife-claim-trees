...
This page gets you from a clean Python environment to a working CLI in under 10 minutes. After this you can run [the first-paper walkthrough](/docs/cli/first-paper/).
...
- [The five subcommands](/docs/cli/subcommands/) — `extract`, `write`, `verify-refs`, `run`, `evaluate`
- [Configuration reference](/docs/reference/config/) — every env var and CLI flag in detail
