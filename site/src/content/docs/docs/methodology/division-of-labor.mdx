...
- [Review modes — when to use each](/docs/cli/review-modes/) — the operational decision in CLI terms
- [The external reviewer](/docs/architecture/external-reviewer/) — what Step 4.5 does and why it exists
- [Validation results](/docs/validation/results/) — empirical performance across the 10-paper public eLife corpus
