...
| `role` | enum | The rhetorical function the claim serves in the paper's argument. One of 9 values (see [the 9 roles](/docs/reference/roles/)). |
...
Edges are top-level keys whose value is a list of target claim slugs. The methodology defines 14 edge types — see [the 14 edge types](/docs/reference/edges/) for the full list. The most common:
...
- [The 9 roles](/docs/reference/roles/) — each role's definition, signal phrases, and edge patterns
- [The 14 edge types](/docs/reference/edges/) — the full edge inventory with reasoning forms
- [What the curator does, what the system does](/docs/methodology/division-of-labor/) — the human/system division of labor
