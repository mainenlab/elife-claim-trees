...
- [The pipeline at a glance](/docs/architecture/pipeline/) for the system's mapping of each step
- [The claim schema](/docs/methodology/schema/) for the data model the system produces
- [What the curator does, what the system does](/docs/methodology/division-of-labor/) for the human-vs-LLM division of labor
