...
<Aside type="tip">
  ...
  ([57% → 71% role on a single targeted prompt change](/docs/validation/iteration/))
...
- [Quick demo — one paper end to end](/docs/overview/quick-demo/) — see the system run on Headley 2026
- [The pipeline at a glance](/docs/architecture/pipeline/) — the architecture diagram
- [Install and configure](/docs/cli/install/) — get it running on your infrastructure
- [The 10-paper sweep results](/docs/validation/results/) — the empirical case
